...
<nav
class="w-screen overflow-scroll bg-white border-b dark:bg-slate-900 border-slate-900/10 lg:px-8 dark:border-slate-300/10 lg:mx-0"><div class="px-4 mx-auto max-w-7xl sm:px-16 lg:px-20">
        ...
        <div class="flex items-center justify-center flex-1 sm:items-stretch sm:justify-start">
            ...
            <div class="mx-auto">
                <div class="flex space-x-4">
                    ...
                    <!-- Active: 'text-sky-600 dark:text-white', Inactive 'text-slate-400' -->
                    <a href="#"
                        class="px-3 py-2 text-sm font-medium rounded-md text-slate-400 hover:text-sky-600 dark:hover:text-dark">
                        About
                    </a>
                    <!-- Active: 'text-sky-600 dark:text-white', Inactive 'text-slate-400' -->
                    <a href="#"
                ...
                <div class="flex space-x-4">
                    ...
                    @auth
                        ...
                        <form action="{{route('logout')}}" method="POST">
                            @csrf
                            <a href="#"
                            class="lg:px-3 py-2 text-sm font-medium rounded-md hover:text-sky-600 text-slate-400 dark:hover:text-dark"
